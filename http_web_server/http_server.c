...
void httpd_handler(struct evhttp_request *req, void *arg) {
    ...
    //http://127.0.0.1:8080/username=hsy&password=123456
...
void login_handler(struct evhttp_request *req, void *arg) {
    ...
    cJSON* regist_obj = cJSON_GetObjectItem(root, "regist");
    strcpy(regist, regist_obj->valuestring);

    printf("username = %s, password = %s, regist = %s\n", username, password, regist);
    cJSON_Delete(root);
    printf("----\n");
...
// 注册
void regist_handler(struct evhttp_request *req, void *arg) {
    ...
    printf("username = %s, password = %s", username_obj->valuestring, password_obj->valuestring);
    cJSON_Delete(root);
    printf("----\n");
...
int main(int argc, char *argv[]) {
    ...
    evhttp_set_cb(httpd, "/regist", regist_handler, NULL);
